...
| Focus                      | Key Resources                                                                 | Goals/Activities                                                                 | Estimated Time |
|----------------------------|-------------------------------------------------------------------------------|----------------------------------------------------------------------------------|----------------|
| **Advanced Agent Tools**   | - Video: [Building Agents with MCP](https://youtu.be/kQmXtrmQ5Zg?si=bwduUYKZpAbXKLEa) (45 min)<br>- Course: [MCP with Anthropic](https://www.deeplearning.ai/short-courses/mcp-build-rich-context-ai-apps-with-anthropic/) (full, 3 hrs)<br>- Course: [Computer Use with Anthropic](https://www.deeplearning.ai/short-courses/building-towards-computer-use-with-anthropic/) (Modules 1-2, 2 hrs) | Integrate protocols with debugging in mind. Mini-project: Enhance Week 4 agent with MCP; test for tool mis-binding. | 8 hrs |
